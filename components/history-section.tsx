...
export default function HistorySection({ name, description, image }: HistorySectionProps) {
  return (
    <div className="flex flex-col md:flex-row gap-6 bg-blue-900 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 border border-yellow-500">
