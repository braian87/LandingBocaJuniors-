...
*Mensaje:* ${formData.message}
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            className="bg-blue-800 border-yellow-500 text-yellow-100 placeholder:text-yellow-200/50"
          />
        </div>
      ...
      <Button type="submit" className="w-full bg-yellow-500 hover:bg-yellow-400 text-blue-900 font-bold">
        Enviar a WhatsApp
      </Button>
    </form>
  )
